...
- [X] Mention two parts of Express that you learned about this week.
    ...
    1.) setting up a server to use express as the framework
    2.) learned that if I don't add the line server.use(express.json()) my project will break

- [X] Describe Middleware?

    Middleware is a function that is run by the express router before the request is handled

- [X] Describe a Resource?

    A resource is a named database table

- [X] What can the API return to help clients know if a request was successful?

    Satus codes and JSON objects
